...
for layout in p.listLayouts():
    if layout.mapSeries and layout.mapSeries.enabled and layout_matches_keywords(layout):
        ...
        for pageNum in range(start_page, end_page + 1):
            ...
            page_name = sanitize_filename(original_page_name).upper() + "_"  + str(getattr(ms.pageRow, "pageNum"))
                    ...
                    for row in cursor:
                        ...
                        if part_count > 1:  # Multipart polygon
                            for part_index in range(part_count):
                                ...
                                base_output_name = f"{layout_size}_{use_case}_{page_name}_{get_current_date_format()}"
                            ...
                            unique_page_number = getattr(ms.pageRow, "pageNum")
